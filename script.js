(function(){
  ...
  var i18n = {
    en: {
      ...
      aboutP1: "Eight years on the sales floor of three of Switzerland's best-known luxury houses — Bucherer, Swatch and Coop City — reading a customer's intent in the first ten seconds, translating technical detail (movements, materials, provenance) into a story that closes the sale, in Chinese, German, English and Spanish.",
      ...
      whyCard2Title: "Multilingual, ZH/DE/EN/ES", whyCard2Body: "Native Chinese, German & English at B2–C1, conversational Spanish (B1) — able to sell and support across markets without a translator.",
    ...
    de: {
      ...
      whyCard2Title: "Mehrsprachig ZH/DE/EN/ES", whyCard2Body: "Chinesisch als Muttersprache, Deutsch & Englisch auf B2–C1, Spanisch im Gespräch (B1) — Verkauf und Support über Märkte hinweg, ohne Übersetzer.",
